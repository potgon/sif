...
import { fetchMonthlyTransactionBySubcategory } from '../../../api/expenses/transactions';
...
export default function SubcategoryTransactionsModal({ 
  ...
  }, [isOpen, year, month, subcategoryName]);

  const loadTransactions = async () => {
    setLoading(true);
    setError(null);
    try {
      const data = await fetchMonthlyTransactionBySubcategory(year, month, subcategoryName);
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
                  No hay transacciones para {subcategoryName} en {monthName} {year}
                </Text>
              </View>
            ) : (
              <ScrollView 
